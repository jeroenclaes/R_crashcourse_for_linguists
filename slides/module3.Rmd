...
dataSet<- dataSet %>%
  mutate(broad.regions=recode(broad.regions, 'North'="Top", "East"="Left", "Center"="Middle", "South"="Bottom"))
levels(dataSet$broad.regions)
```
...
levels(dataSet$broad.regions)
dataSet <- dataSet %>%
  mutate(broad.regions = recode(broad.regions, "Left"="Middle"))
levels(dataSet$broad.regions)
```

## 2.6 Taking stock and exercises
- In this part you have learned:
    - How to convert a text column to a factor
    - How to recode factors
...
## 3.3 Taking stock and exercises
- In this part you have learned:
...
## 4.6 Taking stock and excercises
- In this part you have learned:
...
## 5.4 Taking stock and exercises
- In this part you have learned:
    - How to create basic and beautiful plots for your categorical variables with ggplot2
- Go to http://jeroenclaes.be/r_crashcourse_for_linguists/module3.html and perform the excercises under *4. Bar plots*

## 6. Taking stock and Module-final project
