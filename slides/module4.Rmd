...
- Here we find that p < 0.05, so we reject the null hypothesis: 
    - There is less than a 5% chance of finding a result as extreme or more extreme assumping the null hypothesis of no association between negation and *haber* pluralization
