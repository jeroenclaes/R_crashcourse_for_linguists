...
- There's a first excercise waiting for you at : http://www.jeroenclaes.be/r_crashcourse_for_linguists/module4.html, under *1. Loading and exploring the data*, *2.1 Frequency of /r/ by store*, *3.1 Frequency of /r/ by emphasis*, and *4.1 Frequency of /r/ by word*
...
- Please go to : http://www.jeroenclaes.be/r_crashcourse_for_linguists/module4.html, and perform the exercises under 2.3, 3.3, and 4.3 (*Significance test and effect size*)
...
- Please go to : http://www.jeroenclaes.be/r_crashcourse_for_linguists/module4.html, and perform the exercises under 2.4, 3.4, and 4.4 (*Plotting the differences*)
...
- Please go to: http://www.jeroenclaes.be/r_crashcourse_for_linguists/module4.html and take the *5. Quiz*
