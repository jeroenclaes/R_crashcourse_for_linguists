...
- Five modules:
    ...
    - Elements of logistic regression (This module)
...
##  What is logistic regression and why is it used?
##  What is logistic regression and why is it used? (1/9)
...
##  What is logistic regression and why is it used? (2/9)
...
##  What is logistic regression and why is it used? (3/9)
...
##  What is logistic regression and why is it used? (4/9)
...
##  What is logistic regression and why is it used? (5/9)
...
##  What is logistic regression and why is it used? (6/9)
...
##  What is logistic regression and why is it used? (7/9)
...
##  What is logistic regression and why is it used? (8/9)
...
##  What is logistic regression and why is it used? (9/9)
...
##  Data used in this class (2/2)
- We use the `dplyr` function `mutate_if` to convert all strings to factors, which is required for modeling
```{r dataset }
library(readr)
library(dplyr)
dataSet <- read_csv("http://www.jeroenclaes.be/r_crashcourse_for_linguists/datasets/class10_Claes_2014.csv")
dataSet <- dataSet %>% 
  mutate_if(is.character, as.factor)
summary(dataSet)
```

##  Preliminary analyses (1/5)
...
##  `glm`: the Generalized Linear Model
##  `glm`: the Generalized Linear Model (1/3)
...
##  `glm`: the Generalized Linear Model (2/3)
...
##  `glm`: the Generalized Linear Model (3/3)
...
##  The predictors are linearly related to the logit of the dependent variable 
...
##  The model does not generate correct predictions in 100% of the cases 
...
##  How to fit logistic regression models in R (1/2)
...
##  How to fit logistic regression models in R (2/2)
...
##  How to interpret logistic regression models
##  How to interpret logistic regression models (1/4)
...
##  How to interpret logistic regression models (2/4)
...
##  How to interpret logistic regression models (3/4)
...
##  How to interpret logistic regression models (4/4)
...
##  How to assess the fit of logistic regression models
##  How to assess the fit of logistic regression models (1/6)
...
##  How to assess the fit of logistic regression models (2/6)
...
##  How to assess the fit of logistic regression models (3/6)
...
##  How to assess the fit of logistic regression models (4/6)
...
##  How to assess the fit of logistic regression models (5/6)
```{r precisionRecall12 }
...
##  How to assess the fit of logistic regression models (6/6)
...
##  Testing for overfitting and numerical stability: the bootstrap 
##  Testing for overfitting and numerical stability: the bootstrap (1/2)
...
##  Testing for overfitting and numerical stability: the bootstrap (2/2)
...
##  Exercises
- Please go to: http://www.jeroenclaes.be/r_crashcourse_for_linguists/module5.html and perform the exercises
