...
- Method:
    ...
    - You will perform the exercises in a controlled environment on the companion site, http://www.jeroenclaes.be/r_crashcourse_for_linguists. The links to the labs will be on the slides
...
- Please go to http://www.jeroenclaes.be/r_crashcourse_for_linguists and perform the exercises under *1. Installing and loading packages*
...
- There's a second exercise waiting for you at: http://www.jeroenclaes.be/r_crashcourse_for_linguists/module1.html, under *2. Objects and vectors*
...
- This means that if you read a ISO-8559-1-encoded CSV file without specifying the encoding, all non-ASCII characters (e.g., `é,ñ,ç`) will look weird
...
- There's an exercise on importing CSV data waiting for you at: http://www.jeroenclaes.be/r_crashcourse_for_linguists/module1.html, under *3. Loading data from CSV*
