...
test_library_function("dplyr", not_called_msg="Don't forget to load the dplyr package", incorrect_msg="Remember that we use e.g., `library(dplyr)` to load packages")
test_library_function("ggplot2", not_called_msg="Don't forget to load the ggplot2 package", incorrect_msg="Remember that we use e.g., `library(dplyr)` to load packages")
test_library_function("stringi", not_called_msg="Don't forget to load the stringi package", incorrect_msg="Remember that we use e.g., `library(dplyr)` to load packages")
success_msg("Great!")
```
